...
bert_path = r"D:\VideoMatching\checkpoints\chinese-roberta-wwm-ext-base"
data = dict(
    ...
    train=dict(
        ...
        feat_zip_path=r"D:\VideoMatching\data\feat_zips\feats.zip", #TODO
