...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default=r"D:\VideoMatching\train\train_vid_score\config_for_video_score_train_git.py")  # Đường dẫn file cấu hình
    ...
    parser.add_argument('--resume', type=str, default=r"D:\VideoMatching\train\train_vid_score\checkpoints")  # Đường dẫn checkpoint để tiếp tục train
